...
namespace TitanInformationSolutions.Data.Migrations
{
    ...
    [Migration("20190208010128_DesignUpdates")]
    partial class DesignUpdates
    {
            ...
            modelBuilder.Entity("TitanInformationSolutions.Models.instructor_Section", b =>
                {
                    ...
                    b.ToTable("Instructor_Program");
                });

            modelBuilder.Entity("TitanInformationSolutions.Models.InstructorPost", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
